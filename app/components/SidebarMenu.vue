        ...
        <div class="p-6 border-b border-slate-700">
            <div class="flex items-center justify-between">
                <div v-if="!sidebarCollapsed" class="flex items-center gap-3">
                    <svg width="35" height="40" viewBox="0 0 35 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-8 w-8">
                        <path
            ...
            <template v-for="(item, index) in items" :key="index">
                    ...
                    <div class="space-y-1">
                        <template v-for="(subItem, subIndex) in item.items" :key="subIndex">
                            ...
                            >
                                ...
                                <Badge v-if="subItem.badge && !sidebarCollapsed" class="ml-auto" :variant="'secondary'">{{ subItem.badge }}</Badge>
                                <div 
                                    v-if="subItem.shortcut && !sidebarCollapsed" 
                                    class="ml-auto px-2 py-1 text-xs bg-slate-100 text-slate-900 rounded"
                                >{{ subItem.shortcut }}</div>
                                <div 
                ...
                <div v-else>
                    ...
                    >
                        ...
                        <Badge v-if="item.badge && !sidebarCollapsed" class="ml-auto" :variant="'secondary'">{{ item.badge }}</Badge>
                        <div 
