<template>
  <svg
    ...
    :width="size"
  >
    <g transform="matrix(.34923 0 0 .34923 -2.282 -2.195)" :fill="logoColor">
      <defs>
        <path d="M7 6.5h286v287.1H7z" id="a" />
      </defs>
      <clipPath id="b">
...
<script lang="ts" setup>
  ...
  // 根据inverse属性决定logo颜色
  const logoColor = computed(() => (props.inverse ? "#FFFFFF" : "#8A61B9"));
</script>
