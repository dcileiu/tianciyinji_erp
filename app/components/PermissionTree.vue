  ...
  <div class="permission-tree">
    ...
    <div class="flex items-center justify-between mb-4">
      ...
      <div class="flex items-center space-x-2">
        <Button class="text-xs" size="sm" variant="outline" @click="expandAll">
        ...
        <Button class="text-xs" size="sm" variant="outline" @click="selectAll">
          <Check class="w-3 h-3 mr-1" />
          全选
        </Button>

        <Button class="text-xs" size="sm" variant="outline" @click="clearAll">
