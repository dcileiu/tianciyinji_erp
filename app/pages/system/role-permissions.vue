      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card class="lg:col-span-1">
          ...
          <CardContent>
            ...
            <div class="max-h-96 overflow-y-auto">
              ...
              >
                <Users
                  class="w-12 h-12 text-muted-foreground opacity-50 mb-2 mx-auto"
                />
                ...
                >
                  ...
                  <div class="role-stats">
                    <Badge variant="secondary"
                      >{{ role.user_count || 0 }} 个用户</Badge
                    >
                    <Badge variant="secondary"
                      >{{ role.menu_count || 0 }} 个菜单</Badge
                    >
                    <Badge variant="secondary"
                      >{{ role.resource_count || 0 }} 个资源</Badge
                    >
                    <Badge
                      :variant="
        ...
        <div class="lg:col-span-2">
          <div v-if="!selectedRole" class="text-center py-20">
            <ArrowLeft
              class="w-16 h-16 text-muted-foreground opacity-50 mb-4 mx-auto"
            />
              ...
              <CardContent>
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center space-x-2">
                    <Badge
                      :variant="
                        selectedRole.is_system ? 'destructive' : 'default'
                      "
                    >
                    ...
                    <CardContent class="p-4">
                      <div class="menu-tree">
                        <div class="space-y-2">
                          ...
                          >
                            <div
                              class="flex items-center space-x-2 p-2 hover:bg-muted rounded"
                            >
                              <Checkbox
                                :id="menu.key"
...
const saveRole = async () => {
  ...
  try {
    ...
    if (editingRole.value) {
      // 更新角色
      const index = mockRoles.value.findIndex(
        (r) => r.id === editingRole.value?.id
      );
