          ...
          <TableRow v-else>
            <TableCell class="h-24 text-center" :colspan="columns.length">
              <div class="space-y-3" v-if="loading">
                <!-- 骨架屏行 -->
                <div
                  class="grid grid-cols-[auto_1fr_120px_80px_80px_100px_60px] gap-4 p-4 items-center"
                  v-for="i in 3"
                  :key="i"
                >
                  <!-- 复选框列 -->
                  ...
                  <div class="flex items-center space-x-4">
                    <div
                      class="h-12 w-12 bg-muted animate-pulse rounded-lg"
                    ></div>
                    <div class="space-y-2 flex-1">
                      <div
                        class="h-4 bg-muted animate-pulse rounded w-3/4"
                      ></div>
                      <div
                        class="h-3 bg-muted animate-pulse rounded w-1/2"
                      ></div>
                    </div>
                  </div>
                  <!-- 上级部门列 -->
