              ...
              <TableRow>
                <TableCell class="h-24 text-center" colspan="7">
                  <div class="space-y-3" v-if="loading">
                    <!-- 骨架屏行 -->
                    <div
                      class="grid grid-cols-[150px_120px_100px_80px_200px_100px_60px] gap-4 p-4 items-center"
                      v-for="i in 3"
                      :key="i"
                    >
                      <!-- 角色名称列 -->
                      ...
                      <!-- 类型列 -->
                      <div
                        class="h-6 bg-muted animate-pulse rounded w-full"
                      ></div>
                      <!-- 状态列 -->
                      <div
                        class="h-6 bg-muted animate-pulse rounded w-full"
    ...
    <Dialog v-model:open="showModal">
      <DialogContent class="sm:max-w-[600px]">
        ...
        <Tabs class="w-full" default-value="basic">
          ...
          <TabsContent class="space-y-4" value="basic">
          ...
          <TabsContent class="space-y-4" value="permissions">
            <div class="space-y-4">
              ...
              <div class="max-h-80 overflow-y-auto border rounded-lg p-4">
                <div class="text-center py-8" v-if="menuLoading">
                  <div
                ...
                <div
                  ...
                  v-else-if="menuPermissions.length === 0"
                >
        ...
        <DialogFooter>
          <Button variant="outline" @click="closeRoleModal"> 取消 </Button>
          <Button :disabled="loading" @click="handleSaveRole">
            {{ loading ? '保存中...' : '保存' }}
          </Button>
        </DialogFooter>
      </DialogContent>
...
<script lang="ts" setup>
  ...
  const totalPages = computed(() =>
    Math.ceil(filteredRoles.value.length / pageSize)
  );
  ...
  const isMenuExpanded = (menuId: string) => expandedMenus.value.has(menuId);
