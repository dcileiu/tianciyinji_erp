  ...
  <div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <p class="text-muted-foreground">管理系统用户账户，分配角色权限和访问控制</p>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <Input v-model="searchQuery" placeholder="用户名、姓名、邮箱..." class="pl-9" />
            </div>
          </div>
        ...
        <CardContent class="p-6">
          <div class="flex items-center justify-between">
            <div class="space-y-2">
              ...
              <div class="flex items-baseline space-x-3">
                <p class="text-2xl font-bold text-orange-600">{{ userStats.online }}</p>
      ...
      <CardHeader>
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <CardDescription>当前共有 {{ filteredUsers.length }} 个用户</CardDescription>
          </div>
        ...
        <div v-else class="space-y-4">
          ...
          >
            <div class="flex items-center space-x-4">
              ...
              <div class="space-y-1">
                <div class="flex items-center space-x-2">
                  ...
                  <Badge v-if="user.is_online" variant="default" class="text-xs">
                    <div class="w-2 h-2 bg-green-500 rounded-full mr-1"></div>
                    在线
                  </Badge>
                </div>
                ...
                <p class="text-sm text-muted-foreground">
                  {{ user.email }} • {{ getDepartmentName(user.department_id) }} •
            ...
            <div class="flex items-center space-x-6">
              ...
              <div class="text-center">
                ...
                <p class="text-sm font-semibold text-blue-600">{{ user.login_count || 0 }}</p>
              </div>
          ...
          <div class="flex items-center justify-between pt-4">
            <p class="text-sm text-muted-foreground">
              ...
              {{ Math.min(currentPage * Number(pageSize), filteredUsers.length) }} 条，共
      ...
      <DialogContent class="sm:max-w-[600px]">
        ...
        <div class="space-y-4 py-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2">
              <Label>邮箱 *</Label>
              <Input v-model="currentUser.email" type="email" placeholder="请输入邮箱地址" />
            </div>
            <div class="space-y-2">
              <Label>手机号</Label>
          ...
          <div class="space-y-2">
            <Label>备注</Label>
            <Textarea v-model="currentUser.remarks" placeholder="请输入备注信息..." rows="3" />
          </div>
        </div>
    ...
    <Dialog v-model:open="showPasswordModal">
      <DialogContent class="sm:max-w-[400px]">
        <DialogHeader>
          ...
          <DialogDescription>为用户 "{{ resetPasswordUser?.name }}" 设置新密码</DialogDescription>
        </DialogHeader>
        ...
        <div class="space-y-4 py-4">
          ...
          <div class="space-y-2">
            <Label>确认新密码 *</Label>
            <Input v-model="confirmNewPassword" type="password" placeholder="请确认新密码" />
          </div>
        </div>
...
const saveUser = async () => {
  try {
    ...
    // 简单验证
    if (!currentUser.value.username || !currentUser.value.name || !currentUser.value.email) {
      throw new Error('请填写必填字段')
    }

    if (!isEditing.value && currentUser.value.password !== currentUser.value.confirmPassword) {
    ...
    if (isEditing.value) {
      const index = mockUsers.value.findIndex(u => u.id === currentUser.value.id)
      if (index !== -1) {
        mockUsers.value[index] = {
          ...mockUsers.value[index],
          id: mockUsers.value[index]!.id,
...
const confirmResetPassword = async () => {
  try {
    ...
    console.log('密码重置成功:', resetPasswordUser.value?.name)
    closePasswordModal()
  } catch (error) {
