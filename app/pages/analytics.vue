  ...
  <div class="space-y-6">
          ...
          <div class="flex items-center">
            <div class="flex-1">
              ...
              <div class="flex items-center">
                ...
                <Badge
                  class="ml-2"
                  :variant="kpiData.revenueGrowth >= 0 ? 'default' : 'destructive'"
                >
          ...
          <div class="flex items-center">
            <div class="flex-1">
              ...
              <div class="flex items-center">
                ...
                <Badge
                  class="ml-2"
                  :variant="kpiData.ordersGrowth >= 0 ? 'default' : 'destructive'"
                >
          ...
          <div class="flex items-center">
            <div class="flex-1">
              ...
              <div class="flex items-center">
                ...
                <Badge
                  class="ml-2"
                  :variant="kpiData.customersGrowth >= 0 ? 'default' : 'destructive'"
                >
                  {{ kpiData.customersGrowth >= 0 ? '+' : '' }}
                  {{ kpiData.customersGrowth }}%
                </Badge>
              </div>
            </div>
          ...
          <div class="flex items-center">
            <div class="flex-1">
              ...
              <div class="flex items-center">
                ...
                <Badge
                  class="ml-2"
                  :variant="kpiData.conversionGrowth >= 0 ? 'default' : 'destructive'"
                >
                  {{ kpiData.conversionGrowth >= 0 ? '+' : '' }}
                  {{ kpiData.conversionGrowth }}%
                </Badge>
              </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription
            >{{ selectedPeriod === '7d' ? '过去7天' : selectedPeriod === '30d' ? '过去30天' : selectedPeriod === '90d' ? '过去90天' : '过去一年' }}的销售数据</CardDescription
          >
        </CardHeader>
        <CardContent>
          <AreaChart
          ...
          />
          <div class="h-80 flex items-center justify-center" v-else>
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <div class="flex-1 mx-4">
                ...
                <Progress class="h-2" :value="stage.percentage" />
              </div>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription
          >{{ selectedPeriod === '7d' ? '过去7天' : selectedPeriod === '30d' ? '过去30天' : selectedPeriod === '90d' ? '过去90天' : '过去一年' }}热销产品TOP10</CardDescription
        >
      </CardHeader>
      <CardContent>
            ...
            <TableBody>
              ...
              >
                ...
                <TableCell class="text-right"
                  >{{ product.sales.toLocaleString() }}</TableCell
                >
                <TableCell class="text-right"
                  >{{ formatCurrency(product.revenue) }}</TableCell
                >
                <TableCell class="text-right">
                  <Badge
