...
const previewReport = (_report: ReportItem) => {};

const downloadReport = (_report: ReportItem) => {};

const shareReport = (_report: ReportItem) => {};
</script>
