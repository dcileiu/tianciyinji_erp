        ...
        <div class="p-6">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-blue-600">{{ productionStats.totalOrders }}</p>
            </div>
        ...
        <table class="w-full">
          ...
          <tbody>
            <tr v-for="order in productionDetails" :key="order.id" class="border-b hover:bg-muted/50">
              ...
              <td class="p-4">
                <span :class="order.completion_rate >= 0.9 ? 'text-green-600' : order.completion_rate >= 0.7 ? 'text-yellow-600' : 'text-red-600'">
...
import { 
  Download, RefreshCw, Search, ClipboardList, CheckCircle, 
