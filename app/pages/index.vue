      ...
      <div class="grid md:grid-cols-2 gap-6 mb-8">
        <Card class="shadow-lg">
          <CardContent class="p-6">
            <div
              class="w-12 h-12 bg-blue-100 -lg flex items-center justify-center mb-4"
            >
        ...
        <Card class="shadow-lg">
          <CardContent class="p-6">
            <div
              class="w-12 h-12 bg-green-100 -lg flex items-center justify-center mb-4"
            >
        ...
        <Card class="shadow-lg">
          <CardContent class="p-6">
            <div
              class="w-12 h-12 bg-purple-100 -lg flex items-center justify-center mb-4"
            >
        ...
        <Card class="shadow-lg">
          <CardContent class="p-6">
            <div
              class="w-12 h-12 bg-red-100 -lg flex items-center justify-center mb-4"
            >
