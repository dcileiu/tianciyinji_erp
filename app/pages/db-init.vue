              ...
              <div class="flex align-items-center justify-content-between p-4 border-1 border-surface border-round-lg">
                <div class="flex align-items-center gap-3">
                  ...
                  <div>
                    ...
                    <div v-if="steps['check-connection']?.progress > 0" class="mt-1">
                      <ProgressBar :value="steps['check-connection'].progress" class="h-1" />
                    </div>
                  </div>
                </div>
                <Button 
                ...
                <div class="flex align-items-center gap-3">
                  ...
                  <div>
                    ...
                    <div v-if="steps['check-tables']?.progress > 0" class="mt-1">
                      <ProgressBar :value="steps['check-tables'].progress" class="h-1" />
                    </div>
                  </div>
                </div>
                <Button 
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div v-if="steps['check-admin-role']?.progress > 0" class="mt-1">
                      <ProgressBar :value="steps['check-admin-role'].progress" class="h-1" />
                    </div>
                  </div>
                </div>
                <Button 
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div v-if="steps['create-admin']?.progress > 0" class="mt-1">
                      <ProgressBar :value="steps['create-admin'].progress" class="h-1" />
                    </div>
                  </div>
                </div>
                <Button 
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div v-if="steps['assign-role']?.progress > 0" class="mt-1">
                      <ProgressBar :value="steps['assign-role'].progress" class="h-1" />
                    </div>
                  </div>
                </div>
                <Button 
...
const currentStep = computed(() => {
  const runningStep = Object.entries(steps.value).find(([_, step]) => step.status === 'running')
  if (runningStep) {
    const stepNames = {
