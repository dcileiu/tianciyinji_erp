    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <p class="text-muted-foreground">
          欢迎回来，{{ user?.email?.split('@')[0] || '用户' }}！这里是您的业务概览
        </p>
      </div>
          ...
          <div class="flex items-center">
            <div class="space-y-2">
              ...
              <div class="flex items-baseline space-x-3">
                <p class="text-2xl font-bold">¥{{ formatNumber(todaySales) }}</p>
        ...
        <CardContent class="p-6">
          <div class="flex items-center">
            ...
            <div class="ml-auto">
              ...
              >
                <ShoppingCart class="h-4 w-4 text-orange-600 dark:text-orange-400" />
              </div>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent class="p-6">
          <div class="flex items-center">
            <div class="space-y-2">
              ...
              <p class="text-xs text-muted-foreground">本月新增 {{ newCustomers }} 位</p>
            </div>
            <div class="ml-auto">
              <div
          ...
          >
            <div class="text-center space-y-3">
              ...
              <div>
                ...
                <p class="text-xs text-muted-foreground">图表组件将在此处显示</p>
              </div>
            </div>
          </div>
        </CardContent>
            ...
            <div class="space-y-3">
              <div class="flex items-start space-x-3 rounded-lg border p-3">
                ...
                <div class="space-y-1">
                  ...
                  <p class="text-xs text-muted-foreground">{{ formatTime(new Date()) }}</p>
                </div>
              </div>
              <div class="flex items-start space-x-3 rounded-lg border p-3">
                ...
                <div class="space-y-1">
                  ...
                  <p class="text-xs text-muted-foreground">有 {{ pendingOrders }} 个订单待处理</p>
                  <p class="text-xs text-muted-foreground">{{ formatTime(new Date()) }}</p>
                </div>
              </div>
              <div class="flex items-start space-x-3 rounded-lg border p-3">
                ...
                <div class="space-y-1">
                  ...
                  <p class="text-xs text-muted-foreground">系统已更新到最新版本</p>
      ...
      <Card>
        <CardHeader>
          <div class="flex items-center justify-between">
            ...
            <Button variant="ghost" size="sm" @click="navigateTo('/sales/orders')">
              查看全部
          ...
          <div class="space-y-4">
            ...
            >
              <div class="space-y-1">
                ...
                <p class="text-xs text-muted-foreground">{{ formatTime(order.createdAt) }}</p>
              </div>
              <div class="text-right space-y-1">
                <p class="text-sm font-medium">¥{{ formatNumber(order.amount) }}</p>
      ...
      <Card>
        <CardHeader>
          <div class="flex items-center justify-between">
            ...
            <Button variant="ghost" size="sm" @click="navigateTo('/master-data/products')">
              查看全部
              <ArrowRight class="ml-1 h-4 w-4" />
            </Button>
          </div>
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <div class="flex-1 space-y-1">
                ...
                <p class="text-xs text-muted-foreground">销量: {{ product.sales }} 件</p>
              </div>
              <div class="text-right">
                <p class="text-sm font-medium">¥{{ formatNumber(product.revenue) }}</p>
...
const topProducts = ref([
  { id: 1, name: '智能手机 Pro Max', sales: 245, revenue: 588000 },
  { id: 2, name: '无线蓝牙耳机', sales: 189, revenue: 132300 },
  { id: 3, name: '平板电脑 Air', sales: 156, revenue: 468000 },
  { id: 4, name: '智能手表 Series', sales: 134, revenue: 201000 },
  { id: 5, name: '便携充电宝', sales: 98, revenue: 29400 },
])
...
const refreshData = () => {
  // 模拟数据刷新
  todaySales.value = Math.floor(Math.random() * 200000) + 100000
