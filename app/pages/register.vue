        ...
        <form class="flex flex-column gap-4" @submit.prevent="handleRegister">
          ...
          <div class="field">
            <FloatLabel variant="on">
              <IconField class="w-full">
                ...
                <InputText id="department" v-model="form.department" type="text" class="w-full" :disabled="loading" />
              </IconField>
          ...
          <div class="flex flex-column gap-3">
            <div class="text-center text-sm text-surface-600">
              已有账户？
              <Button label="立即登录" link class="p-0 text-primary" @click="$router.push('/login')" />
            </div>
          </div>
        </form>
      </Panel>
