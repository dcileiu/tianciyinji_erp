      ...
      <Card class="bg-blue-50 border-blue-200">
        <CardContent class="p-6">
          <div class="flex items-center justify-between">
            ...
            <div
              class="w-12 h-12 bg-blue-100 -full flex items-center justify-center"
            >
      ...
      <Card class="bg-orange-50 border-orange-200">
        <CardContent class="p-6">
          <div class="flex items-center justify-between">
            ...
            <div
              class="w-12 h-12 bg-orange-100 -full flex items-center justify-center"
            >
      ...
      <Card class="bg-green-50 border-green-200">
        <CardContent class="p-6">
          <div class="flex items-center justify-between">
            ...
            <div
              class="w-12 h-12 bg-green-100 -full flex items-center justify-center"
            >
      ...
      <Card class="bg-purple-50 border-purple-200">
        <CardContent class="p-6">
          <div class="flex items-center justify-between">
            ...
            <div
              class="w-12 h-12 bg-purple-100 -full flex items-center justify-center"
            >
      ...
      <CardHeader>
        <div class="flex justify-between items-center">
          ...
          <span class="text-sm text-gray-600"
            >总收入: ¥{{ formatCurrency(totalAmount) }}</span
          >
        </div>
      </CardHeader>
      <CardContent>
            ...
            <TableBody>
              <TableRow v-for="receipt in filteredReceipts" :key="receipt.id">
                <TableCell>
                  <div>
                    <span
                      class="font-mono bg-gray-100 px-2 py-1 text-blue-600 text-sm"
                    >
                      {{ receipt.receipt_no }}
                    </span>
                ...
                <TableCell>
                  <div class="flex items-center gap-3">
                    <div
                      class="w-8 h-8 bg-blue-100 -full flex items-center justify-center"
                    >
...
const totalAmount = computed(() => {
  return filteredReceipts.value.reduce(
...
// 收款单操作
const viewReceipt = (_receipt: any) => {};
  ...
  try {
    ...
    if (editingReceipt.value) {
      ...
      const index = receipts.value.findIndex(
        (r) => r.id === editingReceipt.value.id
      );
      if (index !== -1) {
